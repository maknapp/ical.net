...
public class Serializer2Tests
{
    ...
    public void CalendarWritesToStream()
    {
        ...
        writer.WriteContentLine("LOCATION", "The Exceptionally Long Named Meeting Room Whose Name Wraps Over Several Lines When Exported From Leading Calendar and Office Software Application Microsoft Office 2007");
        writer.WriteContentLine("X-ALT-DESC", """<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2//EN">\n<HTML>\n<HEAD>\n<META NAME="Generator" CONTENT="MS Exchange Server version 08.00.0681.000">\n<TITLE></TITLE>\n</HEAD>\n<BODY>\n<!-- Converted from text/rtf format -->\n\n<P DIR=LTR><SPAN LANG="en-gb"></SPAN></P>\n\n</BODY>\n</HTML>""");

        writer.WriteContentLine("X-ABC-MULTIBYTE", "🎈👍😄🎈👍😄🎈👍😄🎈👍😄🎈👍😄");
        writer.WriteContentLine("X-ABC-MULTIBYTE", "🎈👍😄🎈👍😄🎈👍😄🎈👍😄🎈👍😄🎈👍😄🎈👍😄🎈👍😄🎈👍😄");
