...
public class SerializationPerfTests
{
    ...
    [Benchmark]
    public void Deserialize2() => _ = Serialization2.CalendarSerializer.Deserialize<Calendar>(SampleEvent);
    ...
    [Benchmark]
    public void BenchmarkSerializeCalendar2() => Serialization2.CalendarSerializer.Serialize(simpleCalendar);
    ...
    {
        Serialization2.CalendarSerializer.Serialize(multibyteCal);
    }
...
const string iCalString =
    ...
    {
        _ = Serialization2.CalendarSerializer.Deserialize<Calendar>(iCalString);
    }
}
