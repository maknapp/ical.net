...
public class CalendarSerializerOptions
{
    private Dictionary<string, CalendarConverter>? _converters;

    public Dictionary<string, CalendarConverter> Converters => _converters ??= [];
    ...
    internal CalendarConverter GetConverter(string name)
    {
