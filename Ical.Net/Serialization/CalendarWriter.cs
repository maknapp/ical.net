...
public sealed class CalendarWriter
{
    ...
    private const int NextByteLimit = 74;
    ...
    private void WriteContentLine(char[] line, int lineLength)
    {
        ...
        while (start < lineLength)
        {
            ...
            // Write next line
            charCount = FindCharCount(line, start, lineLength - start, NextByteLimit);
    ...
    public void WriteValue(Uri uri) => WriteValueRaw(uri.OriginalString);
