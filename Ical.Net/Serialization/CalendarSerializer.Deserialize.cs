...
public partial class CalendarSerializer
{
        ...
        CalendarSerializerOptions options) where T : CalendarComponent
    {
        ...
        {
            var componentName = reader.GetTextValue();
        ...
        try
        {
            ...
            try
            {
                propertyValue = converter.ReadObject(reader, property.Parameters);
            }
            ...
            if (converter.IsListValue && propertyValue is IEnumerable valueList)
            {
